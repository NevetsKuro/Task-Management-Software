...
!function(a) {
    ...
    var e = function(b, c) {
        ...
        a(window).bind("orientationchange resize " + this.displayAllTrigger, function() {
            e.$dropdownContainer.find("input").trigger("updateCheck"),
            a.proxy(e.updateSpanningCells(), e)
        })
    };
    e.DEFAULTS = {
    ...
    e.prototype.createButtonToolbar = function() {
        ...
        this.$dropdownGroup = a('<div class="btn-group dropdown-btn-group pull-right" />'),
        this.$dropdownBtn = a('<button class="btn btn-default dropdown-toggle" data-toggle="dropdown">Display <span class="caret"></span></button>'),
        this.$dropdownContainer = a('<ul class="dropdown-menu"/>'),
        this.options.addFocusBtn && (this.$focusGroup = a('<div class="btn-group focus-btn-group" />'),
        this.$focusBtn = a('<button class="btn btn-default">Focus</button>'),
    ...
    e.prototype.focusOnRow = function(b) {
        if (this.$table.hasClass("focus-on")) {
            ...
            this.clearAllFocus(),
            c || (this.$bodyRows.addClass("unfocused"),
            a(b).addClass("focused"))
        }
    }
    ,
    ...
    e.prototype.preserveDisplayAll = function() {
        ...
        a(this.$table).find("th, td").css("display", b),
        this.$tableClone && a(this.$tableClone).find("th, td").css("display", b)
    }
    ,
    ...
    e.prototype.updateStickyTableHeader = function() {
        ...
        if (h) {
            if (b.$stickyTableHeader.scrollLeft(b.$tableScrollWrapper.scrollLeft()),
            b.$stickyTableHeader.addClass("fixed-solution"),
            c = i - 1,
            e - d > f ? (c -= e - d - f,
            b.$stickyTableHeader.addClass("border-radius-fix")) : b.$stickyTableHeader.removeClass("border-radius-fix"),
            k)
        ...
        b.$hdrCells.each(function(c) {
            ...
            d.is("[data-priority]")) {
                ...
                g.find("input").click(function(a) {
                    ...
                    b.$table.hasClass("display-all") && (a.proxy(b.preserveDisplayAll(), b),
                    b.$table.removeClass("display-all"),
                    b.$tableClone && b.$tableClone.removeClass("display-all"),
                    b.$displayAllBtn.removeClass("btn-primary")),
                    e.each(function() {
                        var b = a(this);
                        c.is(":checked") ? ("none" !== b.css("display") && b.prop("colSpan", parseInt(b.prop("colSpan")) + 1),
                        b.show()) : parseInt(b.prop("colSpan")) > 1 ? b.prop("colSpan", parseInt(b.prop("colSpan")) - 1) : b.hide()
                    })
        ...
        b.$bodyRows.each(function() {
            ...
            a(this).find("th, td").each(function() {
                for (var d = a(this), e = "", f = d.prop("colSpan"), g = 0, h = c; c + f > h; h++) {
                    ...
                    j && d.attr("data-priority", j),
                    "none" === i.css("display") && g++
                }
                f > 1 && (d.addClass("spn-cell"),
                g !== f ? d.show() : d.hide()),
                d.prop("colSpan", Math.max(f - g, 1)),
                e = e.substring(1),
                d.attr("data-columns", e),
                c += f
            })
        })
    }
    ...
    e.prototype.updateSpanningCells = function() {
        ...
        b.$table.find(".spn-cell").each(function() {
            for (var b = a(this), c = b.attr("data-columns").split(" "), d = c.length, e = 0, f = 0; d > f; f++)
                "none" === a("#" + c[f]).css("display") && e++;
            e !== d ? b.show() : b.hide(),
            b.prop("colSpan", Math.max(d - e, 1))
        })
    }
    ;
    ...
    a.fn.responsiveTable = function(b) {
        return this.each(function() {
            ...
            "" !== f.pattern && (d || c.data("responsiveTable", d = new e(this,f)),
            "string" == typeof b && d[b]())
        })
    }
    ,
    ...
    a(document).ready(function() {
        ...
        a("html").addClass(b() ? "mq" : "no-mq"),
        a("html").addClass(c() ? "touch" : "no-touch")
    })
}(jQuery);
