...
h+= '                                            <a href="http://lancecoder.com/themes/calibre/layouts/iconic/index.php#" class="btn btn-default btn-block btn-flat">Profile</a>' ;
h+= '                                            <a href="http://lancecoder.com/themes/calibre/layouts/iconic/index.php#" class="btn btn-default btn-block btn-flat">Settings</a>' ;
h+= '                                            <a href="http://lancecoder.com/themes/calibre/layouts/iconic/index.php#" class="btn btn-default btn-block btn-flat">Logout</a>' ;
h+= '                                        </div>' ;
h+= '                                    </div>' ;
h+= '                                </li>' ;
h+= '                            </ul>' ;
